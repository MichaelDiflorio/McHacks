...
public class MusicClipMaker {
	    ...
	    public mergeFileParts(String filename1, int splitval) throws IOException {
	        FileInputStream fis = null;
	        FileOutputStream fos = null;
	        try {
	            String name1 = filename1.replaceAll(".mp3", "");
		...
		private void check(String filename1, String mergeFile) {
			// TODO Auto-generated method stub
			
		}

		private void mergeFileParts(String filename1, int splitval) {
			// TODO Auto-generated method stub
